...
public class VrActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl10) {
            TextView t1 = (TextView) findViewById(R.id.txtTwo);
...
//                p1.setProgress((int)(angleDiff/(2*targetSpeed)*100));
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.switch_viewer) {
            ...
            final EditText edit_beta = (EditText) textEntryView.findViewById(R.id.edit_beta);
            ...
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    String str_beta = edit_beta.getText().toString();
                    beta = Float.parseFloat(str_beta);
//          Log.e("log", aSpeed+","+bSpeed+","+aAngle+","+bAngle);
                    nativeSetParameter(nativeApp, beta);
                }
            });
...
//            final String[] items = {"线性", "下凸：慢快", "上凸：快慢"};
//            AlertDialog.Builder builder = new AlertDialog.Builder(this);
...
//    }
    ...
    private native void nativeSetParameter(long nativeApp, float bSp);
